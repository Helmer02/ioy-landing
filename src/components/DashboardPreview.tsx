...
export default function DashboardPreview() {
  ...
  return (
    <section id="produtos" className="relative overflow-hidden py-32">
      {/* Background Glows */}
      <div className="pointer-events-none absolute -right-20 top-20 h-[400px] w-[400px] rounded-full bg-primary/14 blur-[110px]" />
      <div className="pointer-events-none absolute -left-20 bottom-20 h-[350px] w-[350px] rounded-full bg-primary/10 blur-[100px]" />
      ...
      <div className="shell relative z-10">
        ...
        <motion.div
          ...
          className="panel relative group overflow-hidden border border-[var(--line)] bg-white/90 p-4 shadow-2xl backdrop-blur-3xl"
        >
          {/* Animated scan line */}
          ...
          {!imageFailed ? (
            <div className="relative overflow-hidden rounded-[20px] border border-[var(--line)] bg-white">
              <Image
              ...
              />
              <div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-primary/[0.08] via-transparent to-transparent" />
            </div>
          ) : (
            <div className="rounded-[20px] border border-[var(--line)] bg-white p-6 md:p-10">
              <div className="mb-8 flex items-center justify-between border-b border-[var(--line)] pb-6">
                ...
                <div className="flex items-center gap-2 px-4 py-1.5 rounded-full border border-[var(--line)] bg-slate-50 text-[10px] uppercase tracking-widest text-slate-500">
                  <Globe size={10} />
                  agenda.ioy.com.br
                </div>
              </div>
              ...
              <div className="grid gap-10 md:grid-cols-[240px_1fr]">
                <aside className="hidden rounded-2xl border border-[var(--line)] bg-slate-50 p-6 md:block">
                ...
                <div className="space-y-8">
                  <div className="grid gap-4 sm:grid-cols-3">
                    {[
                      ...
                      { color: "bg-slate-100", border: "border-[var(--line)]" },
                      { color: "bg-slate-100", border: "border-[var(--line)]" }
                    ].map((style, i) => (
                  ...
                  <div className="rounded-2xl border border-[var(--line)] bg-slate-50 p-8">
                    <div className="mb-8 flex gap-4">
                      {["w-20", "w-24", "w-16"].map((width, i) => (
                        <div key={i} className={`h-1.5 rounded-full bg-slate-300 ${width}`} />
                      ))}
                    </div>
                      ...
                      {[1, 2, 3].map((row) => (
                        <div key={row} className="flex items-center gap-6">
                          ...
                          <div className="flex-1 space-y-2">
                            <div className="h-2 w-32 rounded-full bg-slate-300" />
